...
[Generate]
public class PiggyClicker : Project
{
    public PiggyClicker()
    {
        Name = "PiggyClicker";
...
[Generate]
public class PiggyClickerSolution : Solution
{
    public PiggyClickerSolution()
    {
        Name = "SFML_Piggy_Clicker";
    ...
    public void ConfigureAll(Configuration conf, Target target)
    {
        ...
        conf.AddProject<PiggyClicker>(target);
    }
}